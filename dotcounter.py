...
iface_uploaded = gr.Interface(detect_pips_uploaded,
    inputs=[
        gr.Image(type="numpy", label="Upload Image", sources="upload"),  # Image upload input
        gr.Slider(label="Hue Threshold", minimum=0, maximum=500, step=1)  # Slider for hue threshold
    ],
    outputs=gr.Image(type="numpy", label="Result"),  # Output display
